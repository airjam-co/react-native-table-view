...
var _reactNativeBeaconsManager = _interopRequireDefault(require("@rodrigo77777/react-native-beacons-manager"));
...
function NearByView(_ref) {
  ...
  const [bottomSheetOpen, setBottomSheetOpen] = _react.default.useState(false);
  const [text, setText] = _react.default.useState('');
  const bleValue = _react.default.useRef('');
  const [, setValue] = _react.default.useState(0); // integer state
  const detailContent = _react.default.useRef('');
  const [permission, setHasPermission] = _react.default.useState(undefined);
  ...
  const guideMessages = {
    'QR': /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    ...
    'BLE': /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
      style: styles.description
    }, /*#__PURE__*/_react.default.createElement(_FontAwesome.default, {
      name: 'wifi',
      size: 40,
    ...
    'NUMERIC': /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
      style: styles.description
    }, /*#__PURE__*/_react.default.createElement(_FontAwesome.default, {
      name: 'headphones',
      size: 40,
    ...
    'BLE,QR': /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
      style: styles.description
    }, /*#__PURE__*/_react.default.createElement(_FontAwesome.default, {
      name: 'qrcode',
      size: 40,
      light: true
    }), "\xA0\xA0\xA0", /*#__PURE__*/_react.default.createElement(_FontAwesome.default, {
      name: 'wifi',
      size: 40,
      light: true
    }), '\n', '\n', "Scan the QR code on the artwork label or move closer to the artwork."),
    'BLE,NUMERIC': /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
      style: styles.description
    }, /*#__PURE__*/_react.default.createElement(_FontAwesome.default, {
      name: 'headphones',
      size: 40,
  ...
  const renderInstruction = selectedInterface => {
    ...
    return /*#__PURE__*/_react.default.createElement("p", null, "Visual interface is not set up");
  };
  const showDetail = query => {
    fetchDetailData(query).then(detailResult => {
      ...
      for (let i = 1; i < detailResult.data.length; i++) {
        ...
        if (!template.pageContent[_types.PageTypes.DETAIL]) continue;
        ...
        let pageContent = template.pageContent[_types.PageTypes.DETAIL];
  ...
  const barcode = /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: styles.container
  }, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: styles.scannerContainer
  }, /*#__PURE__*/_react.default.createElement(_expoBarcodeScanner.BarCodeScanner, {
  ...
  const numpad = /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: styles.numPadContainer
  }, /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: styles.numPadText
  }, text), /*#__PURE__*/_react.default.createElement(_Numpad.default, {
  ...
  const bleOnly = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null);
  let visualScanInterface = /*#__PURE__*/_react.default.createElement(_reactNative.Text, null, "Visual interface is not set up");
  ...
  if (selectedInterface.includes('BLE')) {
    ...
    _reactNativeBeaconsManager.default.requestWhenInUseAuthorization();
    _reactNativeBeaconsManager.default.startMonitoringForRegion(region);
    _reactNativeBeaconsManager.default.startRangingBeaconsInRegion(region);
    _reactNativeBeaconsManager.default.startUpdatingLocation();
    _reactNative.DeviceEventEmitter.addListener('beaconsDidRange', data => {
  ...
  if (selectedInterface.includes('QR')) {
    if (!permission) {
      const getBarCodeScannerPermissions = async () => {
        const {
          status
        } = await _expoBarcodeScanner.BarCodeScanner.requestPermissionsAsync();
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactNative.Animated.View, {
    ...
    size: 40,
    light: true
  }), '\n', '\n'), /*#__PURE__*/_react.default.createElement(_reactNative.Text, null, "Artwork is not found")), /*#__PURE__*/_react.default.createElement(_reactNativeSheet.BottomSheet, {
